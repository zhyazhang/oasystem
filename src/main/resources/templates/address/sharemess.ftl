                    ...
                    <div>
                            ...
                            <div class="share-bottom">
                                <a href="javascript:void(0);"
                                   ...
                                   thiscompany="${(du.director.companyname)!'空的'}" style="margin-left: 100px;"> <img
                                            src="/image/${(du.director.imagePath)!'timg.jpg'}"
                                            class="img-circle"/> ${du.director.userName}
                        ...
                        <div class="share-right">
                            ...
                            <div class="share-button">
                                ...
                                <#else>
                                    <button class="btn btn-primary" style="background: #ccc;border:none;" disabled>已处理
                                    </button>
                                </#if>
                            </div>
                        </div>
