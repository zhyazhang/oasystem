...
<div class="box increase">
    <form action="attendancesave" method="post">
        ...
        <div class="box-body">
            ...
            <div class="row">
                ...
                <div class="col-md-6 form-group">
                    ...
                    <input name="remark" class="form-control remark"
                           value="<#if (attends??)&&(attends.attendsRemark??)>${attends.attendsRemark}</#if>"/>
                </div>
        ...
        <div class="box-footer">
            ...
            <input class="btn btn-default active" id="cancel" type="submit" value="取消"
