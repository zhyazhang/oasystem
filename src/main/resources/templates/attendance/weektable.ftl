...
<head>
    ...
    <link href="css/attendance/weektable.css" rel="stylesheet"/>
    <script type="text/javascript" src="js/iconfont.js"></script>
    <script type="text/javascript" src="plugins/My97DatePicker/WdatePicker.js"></script>
    <script type="text/javascript" src="js/attendance/weektable.js"></script>
</head>
<body>
            ...
            <div class="box-header ">
                ...
                <div class="box-body">
                    <div id="refresh" class="thistable">
                        <#include "/attendance/realweektable.ftl">
                    </div>
                </div>
            </div>
        </div>
