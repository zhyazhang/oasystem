		...
		<#else>
			...
			<#else>
				<h3 class="box-title" style="font-size: 12px;">
					<a style="font-size: 12px;" href="intodir?pathid=${nowpath.parentId}">返回上一层 </a>
					>
					<#list allparentpaths as allparenth>
					<a style="font-size: 12px;" href="intodir?pathid=${allparenth.id}">${allparenth.pathName}</a>
					>
					</#list>
					${nowpath.pathName}
				</h3>
					...
					<#list paths as path>
						<div class="file-one">
							...
							<div class="file-name path">
								...
								<#else>
									<div class="filename">
										<a href="intodir?pathid=${path.id}" style="font-size: 12px;">${path.pathName}</a>
									</div>
								</#if>
