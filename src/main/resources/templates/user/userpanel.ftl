                    ...
                    <div class="tab-pane" id="settings">
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    <label class="control-label"><span id="ctl00_cphMain_Label3">真实姓名</span></label>
                                    <input
                                ...
                                <div class="col-md-6 form-group">
                                    <label class="control-label"><span id="ctl00_cphMain_Label5">Email</span></label>
                                    <input
                                ...
                                <div class="col-md-6 form-group">
                                    <label class="control-label"><span id="ctl00_cphMain_Label10">地址</span></label>
                                    <input
                                ...
                                <div class="col-md-6 form-group">
                                    <label class="control-label"><span id="ctl00_cphMain_Label6">学历</span></label>
                                    <input
                                ...
                                <div class="col-md-6 form-group">
                                    <label class="control-label"><span id="ctl00_cphMain_Label7">毕业院校</span></label>
                                    <input
                                ...
                                <div class="col-md-6 form-group">
                                    <label class="control-label"><span id="ctl00_cphMain_Label9">银行账号</span></label>
                                    <input
                                            name="bank" type="text"
                                ...
                                <div class="col-md-6 form-group">
                                    <label class="control-label"><span id="ctl00_cphMain_Label14">生日</span></label>
                                    <input
