        ...
        <div class="bgc-w box">
            ...
            <form action="susave">
                ...
                <div class="box-body">
                    ...
                    <#list revie as list>
                        ...
                        <div class="shen">
                            <p>${(list.poname)!''}：${(list.username)!''}<span
                                        class="pull-right">${(list.retime)!''}</span></p>
                            <div>
                                ...
                                <div class="content">
                                    <p class="pa" style="padding-top: 9px;">审核状态:<i
                                                class="label ${list.statuscolor}">${(list.restatus)!''}</i></p>
                    ...
                    <div class="shen">
                        <p>申请人：${(process.userId.userName)!''}<span class="pull-right">${(process.applyTime)!''}</span>
                        </p>
                        <div>
                            <div style="display:inline-block;position:absolute;">
