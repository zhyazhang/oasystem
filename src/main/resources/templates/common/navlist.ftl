<div class="col-md-12 green">
    ...
    <ul class="nav navbar-nav navbar-left" style="margin-left: -15px;">
        <li><a href="#" class="green-none white">
    ...
    <ul class="nav navbar-nav navbar-right moredeep">
        ...
        <li><a href="javascript:changepath('/infromlist');" class="green-none white">
        ...
        <li><a href="javascript:changepath('/mytask');" class="green-none white">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu" style="padding:0;">
                <li class="user-header green"><img src="/image/${(user.imgPath)!'/timg.jpg'}"
                    ...
                    <p class="white" style="">
                        <span>${user.dept.deptName} </span> / <span> ${user.role.roleName}</span><br>
                        <small>${user.position.name}</small>
                    </p>
                </li>
        ...
        <li style="position: relative;"><a id="history" class="green-none white" data-toggle="dropdown">
