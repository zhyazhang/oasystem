<div id="smallDiv" style="width: 3%; background: red; float: left; display: none;">
	<div class="list-left" style="width: 100%; background: rgb(34, 45, 50);">
...
<!--把最顶上左侧的logo，栅格系统分2份-->
<div class="col-col-1 col-md-2 smallDiv" style="padding: 0; margin: 0; display: block;">
	<div class="col-md-12 green-g">
		<a href="index" class="navbar-brand" style="padding: 8px 40px;"><img src="images/logo.png" /></a>
	</div>
