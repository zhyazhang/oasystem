                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input class="form-control" value="${(menuObj.menuIcon)!'glyphicon-record'}"
                                       name="menuIcon"/>
                            </div>
                            <div class="col-md-6 form-group">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input type="number" min="0" class="form-control" value="${(menuObj.sortId)!'0'}"
                                       name="sortId"/>
                            </div>
                            <div class="col-md-6 form-group">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <#else>
                                    <span class="labels"><label><input name="show"
