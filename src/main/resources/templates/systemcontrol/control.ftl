    ...
    <div class="row ">
        ...
        <div class="rightcolmd">
            ...
            <div class="panel" style="background-color: #00c86c;color: white;">
                ...
                <div class="shrink" style="height: 280px;padding: 10px;">
                    ...
                    <table cellpadding="2" style="border-collapse: collapse;width:100%;" class="calendar" id="calendar">
                        ...
                        <div>
                            ...
                            <span class="glyphicon glyphicon-chevron-right month right"
                                  style="float:right;cursor:pointer;"></span>
                            <div class="yearmonth"
                                 style="text-align:center;width:70%;display:inline;margin-left: 154px;">
                                <div>
                                </div>
                                <tbody>
				...
				position: absolute; color: rgb(105, 103, 103);text-align: center; ">dfdfdf
                    </div>-->
