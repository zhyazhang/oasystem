                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            <label class="control-label"><span>模块名称</span></label>
                             ...
                             <br>
                            <label class="control-label"><span>${(typeObj.typeModel)!''}</span></label>
                        </div>
                        <div class="col-md-6 form-group">
                            <label class="control-label"><span>类型</span></label>
                            <br>
                            <label class="control-label"><span>${(typeObj.typeName)!''}</span></label>
                        </div>
                        <div class="col-md-6 form-group">
                            <label class="control-label"><span>排序值</span></label>
                            <br>
                            <label class="control-label"><span>${(typeObj.typeSortValue)!''}</span></label>
                        </div>
                        <div class="col-md-6 form-group">
                            <label class="control-label"><span>颜色</span></label>
                             <br>
                            <label class="control-label"><span>${(typeObj.typeColor)!''}</span></label>
                        </div>
                    </div>
                </div>
            </div>
